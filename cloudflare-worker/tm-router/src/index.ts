...
<body>
  <main>
    ...
    <section>
      ...
      <ul>
        <li>
          <a href="/tm/replay">Terra Mystica Log Replayer</a>
          <span class="meta">interactive replay viewer</span>
        </li>
        <li>
...
export default {
	async fetch(request: Request, _env: AssetEnv, _ctx: ExecutionContext): Promise<Response> {
